...
INSERT INTO Sys_Menu(UuId, Parent, MenuIndex, Id, Name, Level, Function) (SELECT uuid(), null, max(menu.MenuIndex)+10, 'sysManager', '系统维护', 1, funct.uuid FROM Sys_Function funct, Sys_Menu menu WHERE code='QueryMessage');

INSERT INTO Sys_Menu(UuId, Parent, Id, Name, Level, Function, MenuIndex) (
	SELECT uuid(), menu.uuid, 'addPack', '新增构建包', 3, funct.uuid,
