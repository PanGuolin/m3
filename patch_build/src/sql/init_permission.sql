...
INSERT INTO SYS_FunctionPerm(UUID, code, perName, info, type) VALUES(uuid(), 'HandleMessage', '处理消息', 'com.m3.patchbuild.message.action.HandleMessageAction', 0);
...
INSERT INTO SYS_RolePermission(roleName, permCode) VALUES('[LoginedUser]', 'HandleMessage');
