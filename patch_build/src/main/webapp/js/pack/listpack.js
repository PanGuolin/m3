var mainObj = {
	...
	init : function() {
		$('#ViewPackOP').click(mainObj.viewOperators);
		$('#HandlePack').click(mainObj.handleTask);
		...
		$('#NewPack').click(function(){window.location.href=basePath + "/pack/addbuild.jsp";});
		$('#ViewPackBuildLog').click(function(){openUrlOfSelected("/pack/viewBuildLog?uuid=");});
	},
};
